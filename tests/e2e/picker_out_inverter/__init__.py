...
if __package__ or "." in __name__:
    from .libUT_inverter import *
else:
    from libUT_inverter import *


class DUTinverter(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # All pins
        self.a = xsp.XPin(xsp.XData(0, xsp.XData.In), self.event)
        self.y = xsp.XPin(xsp.XData(0, xsp.XData.Out), self.event)


        # BindDPI or Native pin address
        self.a.BindDPIPtr(self.dut.GetDPIHandle("a", 0), self.dut.GetDPIHandle("a", 1))
        self.y.BindDPIPtr(self.dut.GetDPIHandle("y", 0), self.dut.GetDPIHandle("y", 1))


        # Add2Port
        self.xport.Add("a", self.a.xdata)
        self.xport.Add("y", self.y.xdata)
