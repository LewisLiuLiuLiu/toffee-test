...
class XPort(object):
    ...
    port_vec = property(_pyxspcomm.XPort_port_vec_get, _pyxspcomm.XPort_port_vec_set)
...
ExprOp_CONST = _pyxspcomm.ExprOp_CONST
ExprOp_SIGNAL = _pyxspcomm.ExprOp_SIGNAL
ExprOp_ADD = _pyxspcomm.ExprOp_ADD
ExprOp_SUB = _pyxspcomm.ExprOp_SUB
ExprOp_MUL = _pyxspcomm.ExprOp_MUL
ExprOp_DIV = _pyxspcomm.ExprOp_DIV
ExprOp_MOD = _pyxspcomm.ExprOp_MOD
ExprOp_BAND = _pyxspcomm.ExprOp_BAND
ExprOp_BOR = _pyxspcomm.ExprOp_BOR
ExprOp_BXOR = _pyxspcomm.ExprOp_BXOR
ExprOp_BNOT = _pyxspcomm.ExprOp_BNOT
ExprOp_SHL = _pyxspcomm.ExprOp_SHL
ExprOp_SHR = _pyxspcomm.ExprOp_SHR
ExprOp_LAND = _pyxspcomm.ExprOp_LAND
ExprOp_LOR = _pyxspcomm.ExprOp_LOR
ExprOp_LNOT = _pyxspcomm.ExprOp_LNOT
ExprOp_EQ = _pyxspcomm.ExprOp_EQ
ExprOp_NE = _pyxspcomm.ExprOp_NE
ExprOp_GT = _pyxspcomm.ExprOp_GT
ExprOp_GE = _pyxspcomm.ExprOp_GE
ExprOp_LT = _pyxspcomm.ExprOp_LT
ExprOp_LE = _pyxspcomm.ExprOp_LE
ExprOp_WITHIN = _pyxspcomm.ExprOp_WITHIN
ExprOp_HOLD = _pyxspcomm.ExprOp_HOLD
class ExprNode(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    op = property(_pyxspcomm.ExprNode_op_get, _pyxspcomm.ExprNode_op_set)
    lhs = property(_pyxspcomm.ExprNode_lhs_get, _pyxspcomm.ExprNode_lhs_set)
    rhs = property(_pyxspcomm.ExprNode_rhs_get, _pyxspcomm.ExprNode_rhs_set)
    sig = property(_pyxspcomm.ExprNode_sig_get, _pyxspcomm.ExprNode_sig_set)
    imm = property(_pyxspcomm.ExprNode_imm_get, _pyxspcomm.ExprNode_imm_set)
    width = property(_pyxspcomm.ExprNode_width_get, _pyxspcomm.ExprNode_width_set)
    use_xdata_cmp = property(_pyxspcomm.ExprNode_use_xdata_cmp_get, _pyxspcomm.ExprNode_use_xdata_cmp_set)
    lhs_xdata = property(_pyxspcomm.ExprNode_lhs_xdata_get, _pyxspcomm.ExprNode_lhs_xdata_set)
    rhs_xdata = property(_pyxspcomm.ExprNode_rhs_xdata_get, _pyxspcomm.ExprNode_rhs_xdata_set)
    cost = property(_pyxspcomm.ExprNode_cost_get, _pyxspcomm.ExprNode_cost_set)
    window = property(_pyxspcomm.ExprNode_window_get, _pyxspcomm.ExprNode_window_set)
    last_true_cycle = property(_pyxspcomm.ExprNode_last_true_cycle_get, _pyxspcomm.ExprNode_last_true_cycle_set)
    last_hold_cycle = property(_pyxspcomm.ExprNode_last_hold_cycle_get, _pyxspcomm.ExprNode_last_hold_cycle_set)
    hold_count = property(_pyxspcomm.ExprNode_hold_count_get, _pyxspcomm.ExprNode_hold_count_set)

    def __init__(self):
        _pyxspcomm.ExprNode_swiginit(self, _pyxspcomm.new_ExprNode())
    __swig_destroy__ = _pyxspcomm.delete_ExprNode

# Register ExprNode in _pyxspcomm:
_pyxspcomm.ExprNode_swigregister(ExprNode)
class ExprEngine(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def NewConst(self, v):
        return _pyxspcomm.ExprEngine_NewConst(self, v)

    def NewSignal(self, sig):
        return _pyxspcomm.ExprEngine_NewSignal(self, sig)

    def NewUnary(self, op, child):
        return _pyxspcomm.ExprEngine_NewUnary(self, op, child)

    def NewBinary(self, op, lhs, rhs):
        return _pyxspcomm.ExprEngine_NewBinary(self, op, lhs, rhs)

    def NewCompare(self, op, lhs, rhs):
        return _pyxspcomm.ExprEngine_NewCompare(self, op, lhs, rhs)

    def NewCompareSigSig(self, op, lhs, rhs):
        return _pyxspcomm.ExprEngine_NewCompareSigSig(self, op, lhs, rhs)

    def NewCompareSigConst(self, op, lhs, rhs):
        return _pyxspcomm.ExprEngine_NewCompareSigConst(self, op, lhs, rhs)

    def NewCompareConstSig(self, op, lhs, rhs):
        return _pyxspcomm.ExprEngine_NewCompareConstSig(self, op, lhs, rhs)

    def NewWithin(self, child, window):
        return _pyxspcomm.ExprEngine_NewWithin(self, child, window)

    def NewHold(self, child, window):
        return _pyxspcomm.ExprEngine_NewHold(self, child, window)

    def GetOrCreateSignal(self, cfg, name):
        return _pyxspcomm.ExprEngine_GetOrCreateSignal(self, cfg, name)

    def RegisterExternalSignal(self, name, sig):
        return _pyxspcomm.ExprEngine_RegisterExternalSignal(self, name, sig)

    def ResetState(self):
        return _pyxspcomm.ExprEngine_ResetState(self)

    def CompileExpr(self, expr, cfg):
        return _pyxspcomm.ExprEngine_CompileExpr(self, expr, cfg)

    def Eval(self, root):
        return _pyxspcomm.ExprEngine_Eval(self, root)

    def OptimizeShortCircuitOrder(self, root):
        return _pyxspcomm.ExprEngine_OptimizeShortCircuitOrder(self, root)

    def SetCycle(self, cycle):
        return _pyxspcomm.ExprEngine_SetCycle(self, cycle)

    def Clear(self):
        return _pyxspcomm.ExprEngine_Clear(self)

    def __init__(self):
        _pyxspcomm.ExprEngine_swiginit(self, _pyxspcomm.new_ExprEngine())
    __swig_destroy__ = _pyxspcomm.delete_ExprEngine

# Register ExprEngine in _pyxspcomm:
_pyxspcomm.ExprEngine_swigregister(ExprEngine)
class ComUseExprCheck(ComUseStepCb):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, clk=None):
        _pyxspcomm.ComUseExprCheck_swiginit(self, _pyxspcomm.new_ComUseExprCheck(clk))

    def BindXClock(self, clk):
        return _pyxspcomm.ComUseExprCheck_BindXClock(self, clk)

    def ExprNewConst(self, v):
        return _pyxspcomm.ComUseExprCheck_ExprNewConst(self, v)

    def ExprNewSignal(self, sig):
        return _pyxspcomm.ComUseExprCheck_ExprNewSignal(self, sig)

    def ExprNewUnary(self, op, child):
        return _pyxspcomm.ComUseExprCheck_ExprNewUnary(self, op, child)

    def ExprNewBinary(self, op, lhs, rhs):
        return _pyxspcomm.ComUseExprCheck_ExprNewBinary(self, op, lhs, rhs)

    def ExprNewCompare(self, op, lhs, rhs):
        return _pyxspcomm.ComUseExprCheck_ExprNewCompare(self, op, lhs, rhs)

    def ExprNewCompareSigSig(self, op, lhs, rhs):
        return _pyxspcomm.ComUseExprCheck_ExprNewCompareSigSig(self, op, lhs, rhs)

    def ExprNewCompareSigConst(self, op, lhs, rhs):
        return _pyxspcomm.ComUseExprCheck_ExprNewCompareSigConst(self, op, lhs, rhs)

    def ExprNewCompareConstSig(self, op, lhs, rhs):
        return _pyxspcomm.ComUseExprCheck_ExprNewCompareConstSig(self, op, lhs, rhs)

    def CompileExpr(self, expr, cfg):
        return _pyxspcomm.ComUseExprCheck_CompileExpr(self, expr, cfg)

    def SetExpr(self, name, root):
        return _pyxspcomm.ComUseExprCheck_SetExpr(self, name, root)

    def RemoveExpr(self, name):
        return _pyxspcomm.ComUseExprCheck_RemoveExpr(self, name)

    def ListExpr(self):
        return _pyxspcomm.ComUseExprCheck_ListExpr(self)

    def GetTriggeredExprKeys(self):
        return _pyxspcomm.ComUseExprCheck_GetTriggeredExprKeys(self)

    def ClearExpr(self):
        return _pyxspcomm.ComUseExprCheck_ClearExpr(self)

    def ClearAll(self):
        return _pyxspcomm.ComUseExprCheck_ClearAll(self)

    def Call(self):
        return _pyxspcomm.ComUseExprCheck_Call(self)
    __swig_destroy__ = _pyxspcomm.delete_ComUseExprCheck

# Register ComUseExprCheck in _pyxspcomm:
_pyxspcomm.ComUseExprCheck_swigregister(ComUseExprCheck)
class ComUseFsmTrigger(ComUseStepCb):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, clk=None):
        _pyxspcomm.ComUseFsmTrigger_swiginit(self, _pyxspcomm.new_ComUseFsmTrigger(clk))

    def BindXClock(self, clk):
        return _pyxspcomm.ComUseFsmTrigger_BindXClock(self, clk)

    def LoadProgram(self, program, cfg):
        return _pyxspcomm.ComUseFsmTrigger_LoadProgram(self, program, cfg)

    def Reset(self):
        return _pyxspcomm.ComUseFsmTrigger_Reset(self)

    def Clear(self):
        return _pyxspcomm.ComUseFsmTrigger_Clear(self)

    def IsTriggered(self):
        return _pyxspcomm.ComUseFsmTrigger_IsTriggered(self)

    def GetTriggeredState(self):
        return _pyxspcomm.ComUseFsmTrigger_GetTriggeredState(self)

    def GetCurrentState(self):
        return _pyxspcomm.ComUseFsmTrigger_GetCurrentState(self)

    def ListStates(self):
        return _pyxspcomm.ComUseFsmTrigger_ListStates(self)

    def Call(self):
        return _pyxspcomm.ComUseFsmTrigger_Call(self)
    __swig_destroy__ = _pyxspcomm.delete_ComUseFsmTrigger

# Register ComUseFsmTrigger in _pyxspcomm:
_pyxspcomm.ComUseFsmTrigger_swigregister(ComUseFsmTrigger)
